                    ...
                    <form id="form">
                        <div class="modal-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="apellido" type="text" placeholder="Apellido" autocomplete="off" />
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="correo-electronico" type="email" placeholder="Correo Electronico" autocomplete="off" />
                                        <label for="correo-electronico">Correo Electronico</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="telefono" type="number" placeholder="Telefono" autocomplete="off" />
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="fecha-nacimiento" type="date" placeholder="Fecha de Nacimiento" autocomplete="off" />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header password">
                        <h5 class="modal-title password" id="exampleModalLabel"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="form-password">
                        <div class="modal-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="nueva-contraseña" type="password" placeholder="Nueva Contraseña" />
                                         <label for="nueva-contraseña">Nueva Contraseña</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="confirmar-contraseña" type="password" placeholder="Confirmar Contraseña" />
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="btnReestablecer" class="btn btn-danger">Reestablecer</button>
                        </div>
                    </form>
                </div>
            </div>
